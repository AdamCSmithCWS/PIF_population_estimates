...
We modeled the observed BBS counts in a similar way to many of the common status and trend models for hte BBS [@smith2024] as realizations of a negative binomial distribution with mean $\lambda_{i,j,d,t,s}$ and inverse dispersion parameter $\phi$.
